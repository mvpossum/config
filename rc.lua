...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessUp",function () awful.util.spawn_with_shell("echo $(($(cat /sys/class/backlight/cmpc_bl/brightness) +1)) > /sys/class/backlight/cmpc_bl/brightness") end),
    awful.key({ }, "XF86MonBrightnessDown",function () awful.util.spawn_with_shell("echo $(($(cat /sys/class/backlight/cmpc_bl/brightness) -1)) > /sys/class/backlight/cmpc_bl/brightness") end),
    ...
    awful.key({ modkey, }, "g", function () run_or_raise("geany", { class = "Geany" }) end),
